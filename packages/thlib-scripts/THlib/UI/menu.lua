...
LoadImageFromFile('title_replay', 'THlib/UI/title_replay.png')
LoadImageFromFile('title_save_rep', 'THlib/UI/title_save_rep.png')
...
function replay_saver:render()
    ...
    elseif self.state == 1 then
        Render("title_save_rep", self.x, self.y + ui.menu.sc_pr_line_height + 15 * ui.menu.sc_pr_line_height * 0.5)
        ---- 绘制键盘
        -- 未选中按键
