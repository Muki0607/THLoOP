...
lib.music_room_text = {
    ...
    comment = {
        ...
        [[
            ...
            出處：くろば·U - 《Star Shooter!》

            「數據刪除」
        ]],
        [[
            原曲：ginkiha - Star Chaser! 
            出處：くろば·U - 《Star Chaser!》
        ...
        [[
            ...
            　節奏十分輕快，因為諾艾兒這時還並未意識到對手有多強大。
            　聽著這首曲子，就彷彿能看見笨拙地揮動著法杖的諾艾兒呢。
            　聞起來像散落的魔力。
        ]],
        [[
            原曲：ginkiha - 伊夏·波利斯塔切爾
            出處：ひなゆあ/橋野水葉 - 《AliceInCradle》
        ...
        [[
            ...
            　諾艾兒開始全力以赴，因為背後有她要守護的人。
            　從這裡開始，或許能看到諾艾兒曾見過的攻擊。
            　是時候將它們如數奉還了。
        ]],
        [[
            原曲：An-fillnote - 森のヌシ
        ...
        [[
            ...
            　諾艾兒·柯涅爾的Last Spellcard主題曲。
            
            　對諾艾兒來說，她所生活的世界無疑就是現實；
...
lib.sc_list = {
    {
        ...
        {},
        { "爆咒「地面炸彈」", "箭咒「純白之弓」",
            "引咒「聚能火球」", "防咒「魔法障壁」", "喚咒「使魔召喚」", "仿魔咒「空中迴廊」",
    ...
    },
    {
        ...
        {},
        { "爆咒「地面炸彈　速」", "散咒「純白之弓　散」",
            "引咒「聚能火球　改」", "護咒「魔法加護」", "喚咒「使魔召喚　御」", "仿星咒「銀河鐵道」",
            "仿焱咒「紅蓮祭儀」", "「拼上性命的聖光爆發！」", "境界「明與滅的樊籠」", "結界「十六重護盾大結界」",
    ...
    },
    {
        ...
        {},
        { "爆咒「地面炸彈　速」", "散咒「純白之弓　散」",
            "引咒「聚能火球　改」", "護咒「魔法加護」", "喚咒「使魔召喚　御」", "仿月咒「空明流光」",
            "仿彗咒「流星祈願」", "「拼上性命的聖光爆發！」", "境界「明與滅的樊籠」", "結界「十六重護盾大結界」",
            "「幻夢的搖籃」", "Reality Reverse" }
    }
}

lib.Ixia_scname = { "追咒「純白之弓　誘」", "追咒「純白之弓　誘」", "追咒「純白之弓　改」", "追咒「純白之弓　改」" }
...
lib.player_scname = {
    ...
    sakuya = { '幻葬「夜霧幻影殺人鬼」', '幻世「口關夜的世界」' },
    muki = { '生靈「幻夢蝶華舞」', '散靈「剎那藤結術」', '「幻想華奏」' },
    nenyuki = { '魔夢「夢魂幻想」', '戀星「星魘火花」' },
    noel = { '箭咒「純白之弓」', '爆咒「地面炸彈」', '引咒「聚能火球」' }
}
...
lib.journey_select = {
    ...
    { '閃避無敵時間：1.0x', '作為廚聖直面諾艾兒的審判。\n你所做的一切，都需在此償還。' },
    --Alice
    --kawaisou is kakenai（描けない）
    { '閃避無敵時間：0.5x', '與諾艾兒一同面對愛麗絲。\n她究竟是敵人，還是朋友？' }
}
