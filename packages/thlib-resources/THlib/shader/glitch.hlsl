...
#define num user_data_0.y //最大位移量
...
PS_Output main(PS_Input input)
{
    ...
    float sign_val = Random1DTo1D(uv.y + ranV, 0.546f, 114514.810f) > 0.5f ? 1.0f : -1.0f;
    
    // 对横坐标部分加减
    xy.x = xy.x + Random1DTo1D(uv.y + ranV, 0.546f, 114514.810f) * num * sign_val;
...
// Lua侧调用示例：
/*
lstg.LoadFX("glitch", "glitch.hlsl")

lstg.PostEffect("glitch", "screen", 6, "mul+alpha",
    -- 浮点参数
    {
        { ran:Float(0, 100), 5, 0, 0 },    -- 外部随机变量，最大位移量
    },
)
*/