...
function sakuya_player:shoot()
    ...
    New(sakuya_knife, 'sakuya_bigknife_red', self.x + 6, self.y, 24, 90, 2 * dmgfix3)
    New(sakuya_knife, 'sakuya_bigknife_red', self.x - 6, self.y, 24, 90, 2 * dmgfix3)
...
function sakuya_fake_bullet:init(x, y, r, a, t, master, dmg)
    ...
    task.New(self, function()
        local _l, _r, _b, _t = _x < lstg.world.boundl, _x > lstg.world.boundr, _y < lstg.world.boundb,
            _y > lstg.world.boundt
